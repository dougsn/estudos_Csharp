...
using PessoaValidacaoRemota.Models;

namespace PessoaValidacaoRemota.Controllers
{
    public class PessoasController : Controller
    {
        ...
        // Classe criada para verificar se o usuário já existe e retornar uma resposta em JSON
