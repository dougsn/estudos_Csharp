...
namespace ImagemComLink.Controllers
{
    public class PessoasController : Controller
    {
        ...
        public PessoasController(Contexto context, IHostingEnvironment environment)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("PessoaId,Nome,Foto")] Pessoa pessoa, IFormFile imagem)
        {
            if (ModelState.IsValid)
            {
                ...
                if(imagem != null)
                {
                    using (var fileStream = new FileStream(Path.Combine(linkUpload, imagem.FileName), FileMode.Create))
                    {
